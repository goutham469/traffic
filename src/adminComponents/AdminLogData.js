...
function SessionData() {
  ...
  async function getSessionData() {
    let result = await fetch(`${process.env.REACT_APP_SERVER_BASE_URL}/admin/sessions` );
...
function Logs() {
  ...
  {
    let data = await fetch(`${process.env.REACT_APP_SERVER_BASE_URL}/admin/sessions`);
